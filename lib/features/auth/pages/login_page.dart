      ...
      body: Stack(
        children: [
          ...
          Positioned(
            top: -60,
            left: -60,
            child: _Orb(color: _lime.withOpacity(0.09), size: 420),
          ),
          ...
          Positioned(
            ...
            right: -60,
            child: _Orb(
              color: const Color(0xFFFF641E).withOpacity(0.08),
              size: 380,
            ),
          ),
          // Main content
                      ...
                      SizedBox(
                        ...
                        child: DecoratedBox(
                          decoration: BoxDecoration(
                            ...
                            color: _loading ? _lime.withOpacity(0.2) : null,
...
class _GridPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    final paint = Paint()
      ..color = const Color(0xFFB4FF3C).withOpacity(0.03)
      ..strokeWidth = 1;
    const step = 48.0;

...
class AppGrid {
  ...
  static final double grid44 = 2.75.rem;
  static final double grid48 = 3.rem;
  static final double grid52 = 3.25.rem;
  static final double grid56 = 3.5.rem;
  static final double grid60 = 3.75.rem;
  static final double grid64 = 4.rem;
  static final double grid68 = 4.25.rem;
  static final double grid72 = 4.5.rem;
  static final double grid76 = 4.75.rem;
  static final double grid80 = 5.rem;
  static final double grid84 = 5.25.rem;
  static final double grid88 = 5.5.rem;
  static final double grid92 = 5.75.rem;
  static final double grid96 = 6.rem;
